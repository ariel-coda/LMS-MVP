    ...
    <div className="w-full max-w-md">
      <div className="bg-white px-8 py-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">Inscription Trial LMS</h1>
          <p className="text-gray-600">Découvrez notre plateforme d'apprentissage</p>
        </div>
        ...
        <div className="space-y-6">
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                <label htmlFor="nom" className="block text-base font-medium text-black mb-2">
                  Nom complet *
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full rounded-md px-4 py-4 text-base border ${errors.nom ? 'border-red-500' : 'border-gray-300'} bg-white text-black`}
                  placeholder="Votre nom complet"
                />
                {errors.nom && <p className="mt-1 text-base text-red-500">{errors.nom}</p>}
              </div>

              <div>
                <label htmlFor="fonction" className="block text-base font-medium text-black mb-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full rounded-md px-4 py-4 text-base border ${errors.fonction ? 'border-red-500' : 'border-gray-300'} bg-white text-black`}
                  placeholder="Votre fonction (ex: Directeur, Enseignant...)"
                />
                {errors.fonction && <p className="mt-1 text-base text-red-500">{errors.fonction}</p>}
              </div>

              <button
                type="button"
                onClick={handleNext}
                className="rounded-md w-full bg-blue-600 text-white py-4 px-4 hover:bg-blue-700 transition-colors font-medium text-base cursor-pointer"
              >
                Suivant
              </button>
            </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                <label htmlFor="nomEcole" className="block text-base font-medium text-black mb-2">
                  Nom de l'école *
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleInputChange}
                  className={`w-full rounded-md px-4 py-4 text-base border ${errors.nomEcole ? 'border-red-500' : 'border-gray-300'} bg-white text-black`}
                  placeholder="Nom de votre établissement"
                />
                {errors.nomEcole && <p className="mt-1 text-base text-red-500">{errors.nomEcole}</p>}
              </div>
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 bg-white text-blue-600 py-4 px-4 border border-blue-600 hover:bg-gray-100 transition-colors font-medium text-base cursor-pointer rounded-md"
                >
                  Précédent
                </button>
                <button
                  type="button"
                  onClick={handleNext}
                  className="flex-1 rounded-md bg-blue-600 text-white py-4 px-4 hover:bg-blue-700 transition-colors font-medium text-base cursor-pointer"
                >
                  Suivant
                </button>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div>
                <label htmlFor="telephone" className="block text-base font-medium text-black mb-2">
                  Numéro de téléphone *
                </label>
                <input
                  type="tel"
                  ...
                  onChange={handleInputChange}
                  className={`w-full rounded-md px-4 py-4 text-base border ${errors.telephone ? 'border-red-500' : 'border-gray-300'} bg-white text-black`}
                  placeholder="+237 XX XX XX XX"
                />
                {errors.telephone && <p className="mt-1 text-base text-red-500">{errors.telephone}</p>}
              </div>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  ...
                  className="flex-1 rounded-md bg-blue-600 text-white py-4 px-4 hover:bg-blue-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed text-base cursor-pointer"
                >
