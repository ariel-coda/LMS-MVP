...
export const FeatureSection = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto py-36 gap-12 px-6">
      ...
      <div className="flex flex-col gap-6 flex-1">
        {features.map((feature, i) => (
          ...
          >
            {/* Titre */}
            <h3
              className={`font-medium text-left text-2xl md:text-3xl transition-colors duration-300 
            ...
            >
              ...
              {i === activeIndex && (
                <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className={`h-full ${
                      colorClasses[feature.color].progress
